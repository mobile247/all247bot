...
- [x] Write unit tests for group_service
- [x] Write unit tests for member_service

---

## Phase 3 — Bot Logic [COMPLETE]
...
- [x] Implement `telegram_helpers.py`
...
- [x] Implement `rate_limit_service.py`
...
- [x] Implement `mention_service.py`
...
- [x] Write unit tests for mention_service (batching, format generation)
- [x] Write unit tests for rate_limit_service (cooldown enforcement)

---

## Phase 4 — Handlers & Entry Point [COMPLETE]
> Goal: wire all commands and events, complete main.py
> Files: command_handlers.py, event_handlers.py, main.py

- [x] Implement `command_handlers.py`
...
- [x] Manual end-to-end test checklist (in ARCHITECTURE.md)
...
- [x] Integration test: /setup → /all flow against test SQLite
- [x] Integration test: passive member discovery pipeline
